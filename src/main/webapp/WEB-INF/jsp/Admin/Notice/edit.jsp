    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/notice/editSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="title" id="title" value="${notice.title}" class="layui-input" required>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="content" id="content" required>${notice.content}</textarea>
            </div>
        </div>
