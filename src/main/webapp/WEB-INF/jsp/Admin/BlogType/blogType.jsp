...
<rapid:override name="content">
  ...
  <div class="layui-row">
    <div class="layui-col-md4">
      <form class="layui-form"  method="post" id="myForm" action="/admin/category/add">
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            ...
            <input type="text" name="typeName" placeholder="请输入类型名称" autocomplete="off" class="layui-input" required>
          </div>
          <br>
          <input type="hidden" name="orderNo" value=${total}>
          <%--<div class="layui-input-block">--%>
