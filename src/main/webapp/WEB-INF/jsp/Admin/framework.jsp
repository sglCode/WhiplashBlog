...
<head>
  ...
  <link rel="stylesheet" href="/resource/assets/css/back.css">
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          ...
          <dd><a href="/admin/blogType">分类</a></dd>
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;">
          <img src="${sessionScope.user.imageName}" class="layui-nav-img">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="/admin/blogType">全部分类</a></dd>
          </dl>
        </li>
        <%--<li class="layui-nav-item">--%>
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            <dd><a href="/admin/comment">评论管理</a></dd>
            <dd><a href="/admin/commentReview">评论审核</a></dd>
          </dl>
...
<script src="/resource/assets/js/back.js"></script>
