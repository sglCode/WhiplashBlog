    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/article/insertSubmit">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="title" id="title" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
                <c:forEach items="${blogTypes}" var="t">
                    <input type="radio" name="blogType.id" lay-skin="primary" title="${t.typeName}" value="${t.id}">
                </c:forEach>
            </div>
